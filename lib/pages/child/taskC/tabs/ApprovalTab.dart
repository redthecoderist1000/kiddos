...
class _ApprovalTabState extends State<ApprovalTab> {
  ...
  final todochannel = Supabase.instance.client.channel('approval-channel');
  ...
  Future<dynamic> loadData() async {
    try {
      ...
      throw Exception('Error fetching tasks for approval.');
    }
  }
        ...
        child: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Center(child: Text('No tasks pending approval.'));
            } else {
